...
/*	КОД - УЖАСНАЯ ПОМОЙКА, НО ПОЛНОСТЬЮ МОЙ, И ТАК КАК ЭТО ПЕРВАЯ ИГРА КОТОРУЮ Я ДЕЛАЛ С НУЛЯ
	...
	В CHROME ОШИБОК НЕ ВЫДАЁТ, В GITHUB.IO ПОЯВЛЯЮТСЯ ОШИБКИ И ИНОГДА НЕ НАХОДИТ РЕСУРСЫ (на
	играбильность не слишком влияет), ПОФИКСИТЬ ЭТО НЕ МОГУ, ТАК ТАК ПРОБЛЕМА СКОРЕЕ ВСЕГО
	В САМОЙ ПЛАТФОРМЕ (и во мне тоже).
	
	ИСПРАВИЛ НЕСКОЛЬКО ОШИБОК В КОДЕ, НО GITHUB.IO ЗАЧЕМ-ТО САМ ИХ СОЗДАЁТ, КАК БУДТО ХРАНЯ В СЕБЕ 
	ПРОШЛУЮ ВЕРСИЮ (прим. ошибка с загрузкой кнопок рестарт и меню: ошибку пофиксил, а на github.io
	она осталась, даже когда полностью удалил все файлы и заново их загрузил, так что починить не 
	смогу).
                                                                                                        */
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////
